...
.app-name span {
    ...
    color: #28A745; /* Green to match the logo */
...
<body>
  ...
  <header>
    <div class="logo">
        <a href="#home">
            <img src="https://res.cloudinary.com/dko49jfq3/image/upload/v1732344582/FlogoNoclar_n8u2ig.png" alt="Logo" height="50" width="50">
        </a>
        <div class="app-name">
    ...
    <ul class="items">
        ...
        <li><a href="#">📍 Location <span class="location">Tirupati</span></a></li>
    </ul>
</header>
